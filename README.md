...
This repository is a minimal clean-architecture template for a .NET 10 Web API.

Project structure
- CleanArchitectureTemplate.WebApi: ASP.NET Core Web API project (entry point). Contains controllers, Program.cs and the OpenAPI/Scalar configuration for API documentation.
- CleanArchitecture.UnitTests: xUnit test project for unit tests.
...
3. Run the API: `dotnet run --project CleanArchitectureTemplate.WebApi`
